      ...
      <div className="p-5">
        ...
        <div className="flex flex-wrap gap-1.5 mt-3">
          {drug.target_proteins.map((p) => (
            <span key={p} className="px-2 py-0.5 text-[10px] rounded font-mono bg-cyan-500/5 border border-cyan-500/15 text-cyan-400/80">
              {p}
            </span>
          ))}
        </div>
      ...
      <div className="px-5 pb-4 flex items-center gap-2">
        ...
        {onExplain && (
          <button
            ...
            className="py-2 px-4 text-xs rounded-lg border border-violet-500/30 bg-violet-500/5
